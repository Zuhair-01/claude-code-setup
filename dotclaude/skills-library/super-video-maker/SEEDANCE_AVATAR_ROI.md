...
*Relevant pipeline files in this repo:* `/Users/borjaobeso/Library/CloudStorage/GoogleDrive-borjaobeso1@gmail.com/Other computers/My MacBook Pro/Scripts/projecto-rebelgrowth/AVATAR_HOOK_FORMAT_RUNBOOK.md` and `.agents/skills/super-video-maker/recipes/misotts-article-sprint.json` — both currently bake the Seedance avatar hook in as a default; per this judgment they should be edited to make the avatar an optional/test-only social variable and to add the winner-sentence + uploaded-transcript + VideoObject/Clip schema steps as the Goal-1 core.