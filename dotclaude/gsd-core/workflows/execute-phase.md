...
@$HOME/.claude/gsd-core/references/execute-phase-response-language.md
...
@$HOME/.claude/gsd-core/references/execute-phase-quota-recovery.md
...
**If gaps_found:**
@$HOME/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@$HOME/.claude/gsd-core/references/offer-next.md
</step>
