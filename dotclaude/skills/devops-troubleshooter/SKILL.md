...
For deep implementation, use `docker-patterns`, `kubernetes-deployment`, or `observability-engineer` instead. Use this skill for incident-response/root-cause methodology.
