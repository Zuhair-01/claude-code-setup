...
For deep statistical methodology or EDA code, use `statistical-analysis` or `exploratory-data-analysis` instead. Use this skill for full-workflow/business-framing decisions.
