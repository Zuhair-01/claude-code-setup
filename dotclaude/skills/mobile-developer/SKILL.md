...
For deep platform-specific implementation, use `react-native-architecture`, `swiftui-patterns`, `android-clean-architecture`, or `kotlin-patterns` instead. Use this skill for cross-platform architecture decisions.
