...
For deep hands-on implementation, use the provider-specific skills instead: `aws-skills`, `gcp-cloud-run`, `azure-functions`, `terraform-skill`. Use this skill for cross-cloud architecture/FinOps decisions.
