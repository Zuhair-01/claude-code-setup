...
description: "Diagnoses the specific trust barrier (competence, benevolence, integrity, or legitimacy) a skeptical audience holds toward a brand or offer, and prescribes the right credibility signal, sequenced at the actual decision point. Use when messaging needs calibrated proof/certainty for a skeptical audience, or when overclaiming/underselling is hurting conversion."
risk: safe
source: community
