...
For actual implementation code, use the deep skills instead of this overview: `defi-protocol-templates`
(staking/AMM/governance/lending templates), `nft-standards` (ERC-721/1155 implementation), or
`solidity-security` (vulnerability prevention patterns). Use this skill for architecture-level
decisions and ecosystem/tool selection.
