...
For Stripe-specific deep implementation (checkout sessions, payment intents, subscription code,
customer portal, refund handling), use `stripe-integration` instead — use this skill when the
provider is PayPal/Square, or genuinely unset/multi-provider, or for the cross-provider security
checklist and real-world failure postmortems below.
