...
For PayPal/Square or multi-provider work, or the cross-provider PCI security checklist and
real-world failure postmortems, use `payment-integration` instead.
