...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --source "<caminho-da-skill-criada>" --force
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --source "<caminho>" [--name "nome-override"] [--force]
```

## Cenario 3: Simular Instalacao Sem Fazer Nada (Dry-Run)

```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --source "<caminho>" --dry-run
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --detect
python ~/.claude/skills/skill-installer/scripts/install_skill.py --detect --auto
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --uninstall "nome-da-skill"
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --health
python ~/.claude/skills/skill-installer/scripts/install_skill.py --health --repair
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --rollback "nome-da-skill"
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --reinstall-all
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --status
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/install_skill.py --log
python ~/.claude/skills/skill-installer/scripts/install_skill.py --log 50
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/validate_skill.py "C:\caminho\para\skill"
python ~/.claude/skills/skill-installer/scripts/validate_skill.py "C:\caminho\para\skill" --strict
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/detect_skills.py
python ~/.claude/skills/skill-installer/scripts/detect_skills.py --path "C:\diretorio\especifico"
python ~/.claude/skills/skill-installer/scripts/detect_skills.py --all
```
...
```bash
python ~/.claude/skills/skill-installer/scripts/package_skill.py --source "C:\caminho"
python ~/.claude/skills/skill-installer/scripts/package_skill.py --all
python ~/.claude/skills/skill-installer/scripts/package_skill.py --all --output "~/Desktop"
```

## Verificar Integridade De Zips Existentes

```bash
python ~/.claude/skills/skill-installer/scripts/package_skill.py --verify
python ~/.claude/skills/skill-installer/scripts/package_skill.py --verify --output "~/Desktop"
```
