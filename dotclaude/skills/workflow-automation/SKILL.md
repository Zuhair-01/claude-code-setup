...
- user needs multi-agent coordination -> multi-agent-patterns (Workflow provides infrastructure, orchestration provides patterns)
...
Works well with: `multi-agent-patterns`, `agent-tool-builder`, `backend`, `devops`
