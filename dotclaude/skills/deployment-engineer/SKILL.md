...
For concrete config/code (not just a tool inventory), see `deployment-patterns` — use this skill to
decide which tool/pattern fits, then that one for the actual implementation.
