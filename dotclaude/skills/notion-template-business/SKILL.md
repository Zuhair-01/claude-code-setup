...
- landing page|sales page -> landing-page-generator (Template sales page)
- copywriting|description|headline -> copywriting (Template sales copy)
- SEO|content|blog|traffic -> seo (Template content marketing)
- email|newsletter|list -> email-marketing (Email marketing for templates)
- SaaS|subscription|app -> micro-saas-launcher (Graduating to SaaS)

### Template Launch

Skills: notion-template-business, landing-page-generator, copywriting, email-marketing
...
Works well with: `micro-saas-launcher`, `copywriting`, `landing-page-generator`, `seo`
