...
<required_reading>
@$HOME/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@$HOME/.claude/gsd-core/references/debugger-philosophy.md
...
@$HOME/.claude/gsd-core/references/debugger-bug-taxonomy.md
...
@$HOME/.claude/gsd-core/references/debugger-repro-hardening.md
...
@$HOME/.claude/gsd-core/references/debugger-semantic-recall.md
...
@$HOME/.claude/gsd-core/references/thinking-models-debug.md
...
@$HOME/.claude/gsd-core/references/debugger-sbfl.md
...
- Read @$HOME/.claude/gsd-core/references/common-bug-patterns.md
...
@$HOME/.claude/gsd-core/references/debugger-rca-branching.md
...
@$HOME/.claude/gsd-core/references/debugger-fix-acceptance.md
...
@$HOME/.claude/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@$HOME/.claude/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
